...
; SCC  2023-06-10 : Added support for 512k memory module
...
#IF         MPType = "Z80"
            ;LD   A,0x01
            ;OUT  (0x38),A      ;Select RAM (0x0000 to 0x7FFF)
            CALL SelRAM        ;Select RAM (0x0000 to 0x7FFF)
#ENDIF
#IF         MPType = "Z180"
...
gocpm:      LD   HL,CD_InterruptA   ; TODO remove this write to $40 ?????????????????????????????
...
#IF         MPType = "Z80"
            ...
            OUT  (0x38),A       ;Select RAM (0x0000 to 0x7FFF)
            LD   A,32
            OUT  (0x78),A       ;Select RAM (0x0000 to 0x7FFF)
            INC  A
            OUT  (0x79),A       ;Select RAM (0x0000 to 0x7FFF)
            RET
#ENDIF
...
#IFDEF      DEBUG
            .DS  0xEFE0 - $     ;Fill space 
            .ORG 0xEFE0
#ELSE
            .DS  0xFFE0 - $     ;Fill space 
            .ORG 0xFFE0
#ENDIF
