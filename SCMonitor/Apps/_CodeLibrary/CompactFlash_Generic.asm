...
; SCC  2022-01-08 : v0.7.0  Added support for CF_FASTEST option
;
; **********************************************************************
;
...
@SectorF:   CALL cfWaitDRQ      ;Wait for compact flash DRQ flag
            ...
            LD   E,4            ;1 sector = 4 x 128 byte blocks
@BlockF:    LD   B,128          ;Block size
            OTIR                ;(C)=(HL), HL=HL+1, B=B-1, repeat
            DEC  E              ;Decrement block counter
            JR   NZ,@BlockF      ;Repeat until all blocks read
            POP  BC             ;Preserve sector number and count
            DJNZ @SectorF        ;Repeat for all required sectors
