Memory test program version 3.0 for use with SCMonitor.

This memory test is for Z80 systems with a full 64K of RAM and a mechanism
to page out the ROM (via port 0x38). It also tests 64K of RAM for 512K RAM
modules that use ports 0x78 and 0x79 to select the memory bank.
