...
; 2023-06-10  Added support for 512k memory module (SC714)
...
;           LD   (0xFFF0),A     ;Store shadow copy of paging register
            OUT  ($38),A        ;Write to page register (64k memory)
            LD   A,32
            OUT  ($78),A        ;Write to page register (512k memory)
            LD   A,33
            OUT  ($79),A        ;Write to page register (512k memory)
