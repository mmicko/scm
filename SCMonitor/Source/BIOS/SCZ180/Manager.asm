...
;BiosTouch: .EQU 20221016       ;Last date this BIOS code touched
...
;   On exit:  AF BC DE HL not specified
;             IX IY I AF' BC' DE' HL' preserved
; Hardware timer events are selected as the Z180 includes timers
; Thus there is no need for software generated timer events
