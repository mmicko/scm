...
; **********************************************************************
; Only include the CTC timer polling code once
#IFNDEF     CTC_POLL
#DEFINE     CTC_POLL
; Poll timer
;   On entry: No parameters required
...
; Poll hardware (CTC) generated timer to see if a 1ms event has occurred
CTC_Poll:   PUSH HL
            LD   HL,iHwPrevTim  ;Point to previous (down counter)
#IFDEF      CTC_CLK_7372800
            IN   A,(kCTC1+2)    ;A = current (down counter)
#ENDIF
#IFDEF      CTC_CLK_1843200
            IN   A,(kCTC1+3)    ;A = current (down counter)
#ENDIF
