...
kMonMajor:  .EQU 1              ;Monitor version: major
kMonMinor:  .EQU 3              ;Monitor version: minor
kMonRevis:  .EQU 1              ;Monitor version: revision
;VerMTouch: .EQU 20221016       ;Last date monitor code touched
