; **********************************************************************
; **  Build Small Computer Monitor Configuration SC130                **
; **********************************************************************
...
; Build date
#DEFINE     CDATE "20221016"    ;Build date is embedded in the code

; Configuration identifiers
kConfMajor: .SET 'S'            ;Config: Letter = official, number = user
kConfMinor: .SET '7'            ;Config: 1 to 9 = official, 0 = user
#DEFINE     CNAME "SC130"       ;Configuration name (max 11 characters)

; Hardware ID (use HW_UNKNOWN if not for a very specified product)
kConfHardw: .SET HW_SC130       ;Hardware identifier (if known)
...
#INCLUDE    Config\Modules\SC130.asm
