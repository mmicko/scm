; **********************************************************************
; **  Build Small Computer Monitor Configuration SC714                **
; **********************************************************************
...
; Build date
#DEFINE     CDATE "20230610"    ;Build date is embedded in the code
...
;SC714 SBC/Motherboard (Z80 CPU, RAM, ROM, Clock)
#INCLUDE    Config\Modules\SC714.asm
