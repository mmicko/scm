; **********************************************************************
; **  Build Small Computer Monitor Configuration SC150_151            **
; **********************************************************************
...
; Build date
#DEFINE     CDATE "20221216"    ;Build date is embedded in the code
...
kConfHardw: .SET HW_RCZ80_1     ;Hardware identifier (if known)
...
#INCLUDE    Config\Modules\SC151.asm
...
#INCLUDE    Config\Common\2022-02-18\ROM_Info_SC32k.asm
